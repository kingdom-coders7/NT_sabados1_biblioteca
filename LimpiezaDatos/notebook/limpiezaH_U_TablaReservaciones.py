...
def limpiar_tabla_reservaciones(setDatosSucios):
    ...
    LimpiezaTablaReservaciones['reservationDate'] = pd.to_datetime(
    LimpiezaTablaReservaciones['reservationDate'], errors='coerce'
)

    LimpiezaTablaReservaciones['expDate'] = pd.to_datetime(
    LimpiezaTablaReservaciones['expDate'], errors='coerce'
)
